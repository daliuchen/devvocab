...
| P0-04 | done   | Retire review from active MVP scope.                 | None       | Current MVP focuses on capture, source library, notes, export, and source reopen.                               | Decision is recorded in `plans/DEVELOPMENT_PLAN.md`.                  |
...
| F1-05 | done   | Keep extension pages scoped to popup and library. | F1-02      | Build output exposes popup and library entrypoints only.                   | Inspect Vite inputs and generated extension pages.                  |
...
| D2-06 | done   | Add data query helpers.                        | D2-02        | UI can query recent words, all words, and occurrences by word.                               | Unit tests seed database and verify each query result.                    |
...
| S4-05 | done   | Add basic popup stats.             | D2-06, F1-03 | Popup shows total saved mark count.                                        | Manual popup check after seeding or saving records.                  |
| S4-06 | done   | Add popup navigation link.         | F1-03, F1-04 | Popup can open the library page.                                           | Manual popup check opens the library successfully.                   |

## Phase 5: Library Management Page

| ID    | Status | Task                                    | Depends On   | Acceptance Criteria                                                                | Verification                                            |
| ----- | ------ | --------------------------------------- | ------------ | ---------------------------------------------------------------------------------- | ------------------------------------------------------- |
| V5-01 | done   | Build library page layout.              | F1-04        | Page has search, source list, mark list, and detail area.                          | Manual UI check at desktop and narrow viewport widths.  |
| V5-02 | done   | Render saved source marks.              | V5-01, D2-06 | Saved marks appear grouped by source page.                                         | Manual check with seeded data or saved words.           |
...
| V5-05 | done   | Keep library filtering source-aware.    | V5-02        | Search can match word, context, source title, domain, URL, notes, and definitions. | Manual UI search check.                                 |
| V5-06 | done   | Keep mastery controls out of active UI. | V5-02, D2-06 | Library detail focuses on source context, definitions, notes, and deletion.        | Manual UI check confirms no mastery control appears.    |
...
## Phase 7: Dormant Review Data

| ID    | Status | Task                                          | Depends On | Acceptance Criteria                                                                | Verification                             |
| ----- | ------ | --------------------------------------------- | ---------- | ---------------------------------------------------------------------------------- | ---------------------------------------- |
| W7-01 | done   | Retain review data helpers for compatibility. | D2-02      | Existing local data with review records remains readable and deletable with words. | Unit tests cover review helper behavior. |
| W7-02 | done   | Remove review from active extension UI.       | F1-05      | Build output no longer exposes `review.html` or popup review navigation.           | Inspect build output and popup manually. |
...
| Q9-04 | done   | Add screenshots or demo notes.              | V5-01               | README has enough visuals or notes to explain the MVP.                           | Review README in GitHub preview.                                       |
...
7. Keep review out of active UI unless it is redesigned.
8. Improve definitions only after capture, storage, and source reopen feel solid.
